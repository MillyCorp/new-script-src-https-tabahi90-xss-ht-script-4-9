...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <tr>
    <td>CPU使用状况</td>
    <td colspan="5"><?php if('/'==DIRECTORY_SEPARATOR){echo $cpu_show." | <a href='/tz?act=cpu_percentage' target='_blank' class='static'>查看图表</a>";}else{echo "暂时只支持Linux系统";}?>
	</td>
  </tr>
    <tr>
    <td>硬盘使用状况</td>
...
<table width="100%" cellpadding="3" cellspacing="0" align="center">
  ...
  <tr>
    ...
    <td width="18%">
		...
		$disFuns=get_cfg_var("disable_functions");
		?>
    <?php echo (preg_match("/phpinfo/i",$disFuns))? '<font color="red">×</font>' :"<a href='/tz?act=phpinfo' target='_blank'>PHPINFO</a>";?>
    </td>
  ...
  <tr>
   ...
   <tr>
	...
	<tr>
		...
		<td colspan="3"><a href='/tz?act=Function' target='_blank' class='static'>请点这里查看详细！</a></td>		
	</tr>
	<tr>
